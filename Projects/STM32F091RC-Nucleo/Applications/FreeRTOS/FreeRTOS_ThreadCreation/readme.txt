/**
  ...
  * @version V1.2.0
  * @date    05-Dec-2014 
  * @brief   Description of the STM32F0xx CMSIS RTOS thread creation example.
  ******************************************************************************
  *
...
In case of error, LED2 is turned on and remains on.
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_ThreadCreation/Inc/stm32f0xx_hal_conf.h  HAL Configuration file
    - FreeRTOS/FreeRTOS_ThreadCreation/Inc/stm32f0xx_it.h        Header for stm32f0xx_it.c
    ...
    - FreeRTOS/FreeRTOS_ThreadCreation/Src/stm32f0xx_it.c        STM32 Interrupt handlers

@par Hardware and Software environment

  - This example runs on STM32F0xx devices.
    
  - This example has been tested with a STM32F091RC-Nucleo RevC board embedding
    a STM32F091RCT6 device and can be easily tailored to any other supported device 
