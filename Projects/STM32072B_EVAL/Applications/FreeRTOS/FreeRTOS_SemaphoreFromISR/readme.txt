/**
  ...
  * @version V1.2.0
  * @date    05-Dec-2014 
  * @brief   Description of the STM32F0xx CMSIS RTOS semaphore from ISR example.
  ******************************************************************************
  *
...
Each time the user pushes the Tamper push-button of the board the semaphore 
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_SemaphoreFromISR/Inc/stm32f0xx_hal_conf.h  HAL Configuration file
    - FreeRTOS/FreeRTOS_SemaphoreFromISR/Inc/stm32f0xx_it.h        Header for stm32f0xx_it.c
    ...
    - FreeRTOS/FreeRTOS_SemaphoreFromISR/Src/stm32f0xx_it.c       STM32 Interrupt handlers
