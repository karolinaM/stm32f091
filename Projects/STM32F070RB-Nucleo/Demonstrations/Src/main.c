...
static void TFT_DisplayMenu(void)
{
  ...
  /* Display message */
  BSP_LCD_DisplayStringAtLine(1, (uint8_t*)" NUCLEO-F070RB   ");
  ...
  if(tmp == JOY_UP)
  {
    ...
    BSP_LCD_DisplayStringAtLine(4,  (uint8_t*)"    Manual Mode   ");
    BSP_LCD_DisplayStringAtLine(6,  (uint8_t*)"     Selected     "); 
  ...
  else if (tmp == JOY_DOWN)    
  {
    ...
    BSP_LCD_DisplayStringAtLine(1,  (uint8_t*)"                  ");
    BSP_LCD_DisplayStringAtLine(2,  (uint8_t*)"                  ");
    BSP_LCD_DisplayStringAtLine(4,  (uint8_t*)"  Automatic Mode  ");
    BSP_LCD_DisplayStringAtLine(6,  (uint8_t*)"     Selected     ");
    ...
    BSP_LCD_DisplayStringAtLine(11,  (uint8_t*)" SEL = Switch to  ");
    BSP_LCD_DisplayStringAtLine(12,  (uint8_t*)" manual mode      "); 
    HAL_Delay(200);
  }
}
...
/**
  ...
  * @retval None
  */
JOYState_TypeDef joystickstatus = JOY_NONE;
static void TFT_DisplayImages(void)
{    
  uint32_t bmplen = 0;
  uint32_t checkstatus = 0;
