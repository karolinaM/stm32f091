/**
  @page Demo   Demo STM32F070RB-Nucleo RevC
  ...
  * @version V1.2.0
  * @date    05-Dec-2014
  * @brief   Description of STM32F070RB-Nucleo RevC Demo
  ******************************************************************************
  *
...
access to uSD card to parse bmp images:
 ...
 - If SD Card is not FAT16 formatted, a message will be displayed on TFT. 
...
- SD card with capacity up to 2GB are supported(SDHC cards are not supported).
