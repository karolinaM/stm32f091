...
use USB device application based on the Device Firmware Upgrade (DFU) on the STM32F0xx devices.
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32F072B-Discovery board and can be easily tailored 
